...
<head>
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
		  <img src="/tastyMap/resources/images/logo.png"/>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item" id="pop"><span class="nav-link" data-toggle="popover"><img src="/tastyMap/resources/images/bell.png" data-toggle="popover"></span></li>
			  <li class="nav-item"><a href="login.html" class="nav-link"><img src="/tastyMap/resources/images/user1.png" alt=""></a></li>
			  <li class="nav-item"><a href="Mypage.html" class="nav-link"><img src="/tastyMap/resources/images/user1.png" alt=""></a></li>
	        </ul>
	      </div>
	    </div>
	  </nav>
		...
		<div class="panel panel-default" id="myLargeModal">
			...
			<div class="panel-body" >
				...
				<div class="row" style="width: 500px;">
					...
					<img src="/tastyMap/resources/images/res/res1.jpg" style="width: 70px;">
				</div>
				<hr>
				<div class="row" style="width: 500px;">
					<div class="col-lg-2">
					...
					<img src="/tastyMap/resources/images/res/res2.jpg" style="width: 70px;">
				</div>
				<hr>
			</div>
